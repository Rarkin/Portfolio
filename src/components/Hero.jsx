  ...
  return (
    <div name='hero' className='w-full h-screen bg-gradient-to-r from-[#0f2027] via-[#203a43] to-[#2c5364] ...'>
        ...
        <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
            ...
            <p className='text-[#ccd6f6] py-4 max-w-700'>Check out my projects below! also feel free to check out my Linkedin, Github & Resume located on the sidebar. If you like what you see shoot me an email also located on the sidebar or send a message through my contact section.</p>
            <div>
